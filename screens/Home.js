...
const Home = ({ navigation }) => {
  const profileData = {
    name: "Maryam And Fizza",
    point: 500,
  };

  const bookIfWeWereVillians = {
    id: 1,
    bookName: "If We Were Villians",
    bookCover: images.IfWeWereVillians,
    rating: 5,
    language: "Eng",
    pageNo: 200,
    author: "M.L. RIO",
    ...
    readed: "20k",
    description:
      "If We Were Villains by M.L. Rio is a dark, suspenseful novel about a group of elite Shakespearean actors at an arts academy, whose intense relationships and rivalries lead to a tragic crime that mirrors the dramatic tragedies they perform.",
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.darkRed }}>
      {/* Header Section */}
